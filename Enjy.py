...
class ImageViewer(QtCore.QObject):
    smallest_size = None
    instances = []
    def _init_(self, image_widget, ft_widget, combo_box, detect_first_time, img_FtComponent, ROI_rectangles):
        super()._init_()
...
class fourierComponents(QtCore.QObject):
    def _init_(self, original_image, ft_widget, ROI_rectangles):
        super()._init_()
