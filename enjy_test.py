...
class ImageViewer(QtCore.QObject):
    smallest_size = None
    instances = []
    def __init__(self, image_widget, ft_widget, combo_box, detect_first_time):
        super().__init__()
...
class fourierComponents(QtCore.QObject):
    def __init__(self, original_image, ft_widget):
        super().__init__()
    ...
    def draw_rectangle(self, detect_first_time):
        ...
        self.roi = pg.RectROI(
            ...
            pen=pg.mkPen("b", width=2), resizable = 'True' , movable=True
        )
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        for i in range(4):  # Create 4 sets of widgets
            ...
            image_events_handler = ImageViewer(image_widget, ft_widget, combo_box, detect_first_time)
